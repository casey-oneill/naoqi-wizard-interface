...
class NaoqiProxy(NaoProxy):
    ...
    def fakeError(self):
        self.animated_speech.say("\\rspd=85\\\\vct=90\\\\vol=85\\Oh no I", self.animated_speech_config)
        self.animated_speech.say("\\rspd=60\\\\vct=45\\\\vol=85\\seem to be malfunctioning\\pau=50\\", self.animated_speech_config)
        self.animated_speech.say("\\rspd=30\\\\vct=20\\\\vol=85\\error\\pau=75\\", self.animated_speech_config)
        self.animated_speech.say("\\rspd=10\\\\vct=5\\\\vol=90\\error\\pau=75\\", self.animated_speech_config)
        self.animated_speech.say("\\rspd=5\\\\vct=5\\\\vol=90\\error", self.animated_speech_config)
        self.animated_speech.say("\\rspd=5\\\\vct=5\\\\vol=90\\I\\pau=100\\I\\pau=100\\I\\pau=100\\", self.animated_speech_config)
        self.motion.rest()
        self.leds.rasta(5)
        self.motion.wakeUp()
        self.sayAnimated("Whoops! What happened?")
